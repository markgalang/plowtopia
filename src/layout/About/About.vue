  ...
  <div class="aboutContainer">
    ...
    <div class="textContainer">
      <p class="textParagraph">
        ...
        However, a number of the ground-breaking technology would facilitate the
        development of the irrelevance of potential.
      </p>
      <p class="textParagraph">
        ...
        flexible production planning. Such tendency may automatically originate
        from the relational approach.
      </p>
      <p class="textParagraph">
...
<script>
import AboutBanner from "@/assets/about-label.svg";
